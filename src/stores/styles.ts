...
export const useStyleStore = defineStore({
    ...
    state: (): StyleState => ({
        ...
        ButtonStyle: {
            ...
            veterinarian:
                'flex w-1/4 justify-center rounded-md py-2 text-lg text-white/70 hover:bg-gradient-to-r hover:text-white focus:outline-none bg-sky-600 hover:from-sky-800 hover:via-sky-600 hover:to-sky-800 focus:ring-sky-500 active:from-sky-600 active:via-sky-800 active:to-sky-600 active:text-sky-200',
