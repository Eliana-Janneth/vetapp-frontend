...
url.searchParams.append('name', props.chat.userName);
...
<template>
    <button
        class="flex shrink-0 select-none items-center rounded-lg bg-gray-200 px-4 py-2 shadow duration-150 hover:scale-95"
    >
